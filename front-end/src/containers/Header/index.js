...
class Header extends React.Component {
    ...
    render() {
        ...
        const drawerStyle = (drawerType.includes(FIXED_DRAWER) || drawerType.includes(MINI_DRAWER)) ? 'd-block d-xl-none' : drawerType.includes(COLLAPSED_DRAWER) ? 'd-block' : 'd-none';
                            ...
                            <Dropdown
                                ...
                                <DropdownToggle
                                    ...
                                    <IconButton className="icon-btn">
                                        <i className={`flag flag-24 flag-${locale.icon} language-switcher`}/>
                                    </IconButton>
                                </DropdownToggle>
